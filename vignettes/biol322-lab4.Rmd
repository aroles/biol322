...
| Shaina and Elise | Aidan and Martha (both absent) |
...
Selection occurs when genotypes differ (on average) in their survival and/or reproduction—their **fitness**. We will add relative fitness terms for each genotype to our flow equations to determine how many new zygotes are created each generation.
