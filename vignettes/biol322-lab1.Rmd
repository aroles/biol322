...
![View of the opening window of Vensim](man/figures/vensim-workspace.png)

```{r vensim img, fig.align = 'center', fig.height = 4, fig.width = 7, echo = FALSE, fig.alt="View of the opening window of Vensim"}
knitr::include_graphics(file.path(here::here(), 'man', 'figures', 'vensim-workspace.png'), dpi = 100)
```

<img src="man/figures/vensim-workspace.png" alt="View of the opening window of Vensim" style="width:600px; height:326px; padding:0em;">
...
<img src="labimg/twoflowexponential.png" alt="View of the opening window of Vensim" style="width:400px; height:160px; padding:0em;"></li>
...
Submit your responses to the Google Form: <a href="https://forms.gle/E3QLACX1aA2Q6ist5">https://forms.gle/E3QLACX1aA2Q6ist5</a>. Write-up are due by the next lab period.
